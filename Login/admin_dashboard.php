...
<body>
    ...
    <div class="card-deck">
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-info"
                    onclick="location.href = '../company/infosys/admin_infosys.php';">
                    Feedback
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-info"
                    onclick="location.href = '../company/keltron/admin_keltron.php';">
                    Feedback
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-info"
                    onclick="location.href = '../company/wipro/admin_wipro.php';">
                    Feedback
                </button>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-footer">
                <button type="button" class="btn btn-info"
                    onclick="location.href = '../company/zoople/admin_zoople.php';">
                    Feedback
                </button>
            </div>
        </div>
